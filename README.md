...
`Python` · `Flask` · `JavaScript / TypeScript` · `React` · `Next.js` · `Astro` · `Tailwind` · `Supabase / Postgres` · `Cloudflare (Workers · Pages · D1)` · `Docker` · `Shopify (Liquid · CLI)` · `Linux / VPS` · `AI agents`

## 📫 Get in Touch

- GitHub: [@Csierra088](https://github.com/Csierra088)
- Email: serioguy99@gmail.com
<!-- Add your socials whenever you want: -->
